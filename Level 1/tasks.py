...
def log_in():
    ...
    page = browser.page()
    page.fill("#username", "maria") # (#) defines id. here username is a id
    page.fill("#password", "thoushallnotpass")
    #Click a button that has exact label Log in
...
def fill_and_submit_sales_form(sales_rep):
    ...
    #sales is dictionary her and python doesnt need variables defines
    page = browser.page()
    page.fill("#firstname", sales_rep["First Name"])
    page.fill("#lastname", sales_rep["Last Name"])
    page.select_option("#salestarget", str(sales_rep["Sales Target"]))
    page.fill("#salesresult", str(sales_rep["Sales"]))
    #text=Submit is targeting selector by label doesnt need to be button, can be div or other tag
